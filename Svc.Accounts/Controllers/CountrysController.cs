...
/// <inheritdoc />
public class CountrysController(ILogger<CountrysController> logger, IRepository repository)
    : BaseEntityController<Country, CountryQueryCriteria>(logger, repository)
{
    /// <summary>
