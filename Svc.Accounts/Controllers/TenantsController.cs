...
/// <inheritdoc />
public class TenantsController(ILogger<TenantsController> logger, IRepository repository)
    : BaseEntityController<Tenant, TenantQueryCriteria>(logger, repository)
{
    /// <summary>
